...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="product_add('添加房型','getAddHouses')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加房型</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				<c:forEach items="${housesList}" var="housesList" varStatus="status">
					<tr class="text-c">
