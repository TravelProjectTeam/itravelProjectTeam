	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray">
			<span class="l"> <a href="javascript:;" onclick="datadel()"
				...
				onclick="admin_role_add('添加角色','adminRoleAdd','800')"><i
		...
		<table class="table table-border table-bordered table-hover table-bg">
			...
			<tbody>
			<c:forEach items="${userAdminList}" var="userAdminList">
				<tr class="text-c">
					<td><input type="checkbox" value="" name=""></td>
					<td>${userAdminList.id}</td>
					<td>${userAdminList.status}</td>
					<td><a href="#">${userAdminList.name}</a></td>
					<td>拥有至高无上的权利</td>
					<td class="f-14"><a title="编辑" href="javascript:;"
						onclick="admin_role_edit('角色编辑','admin-role-add.html','1')"
						style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a title="删除" href="javascript:;"
						onclick="admin_role_del(this,'id=${userAdminList.id}')" class="ml-5"
