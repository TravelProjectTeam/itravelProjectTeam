		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs"
					href="/aboutHui.shtml">锦江国际管理系统</a> <a aria-hidden="false"
				...
				<nav id="Hui-userbar"
					...
					<ul class="cl">
						...
						<li class="dropDown dropDown_hover"><a href="#"
							class="dropDown_A">${backUserSession.userName} <i class="Hui-iconfont">&#xe6d5;</i></a>
							<ul class="dropDown-menu menu radius box-shadow">
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<dl id="menu-article">
				...
				<dd>
					<ul>
						<li><a data-href="article-list.jsp" data-title="资讯管理"
			...
			<dl id="menu-picture">
				...
				<dd>
					<ul>
						<li><a data-href="picture-list.jsp" data-title="图片管理"
			...
			<dl id="menu-comments">
				...
				<dd>
					<ul>
						...
						<li><a data-href="feedback-list.jsp" data-title="意见反馈"
